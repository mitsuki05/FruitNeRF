...
def sample_volume(
    ...
    Args:
        ...
        output_dir: save pcds to output dir.
        config: config file.
        transform_json: transform json file.
    ...
    with progress as progress_bar:
        ...
        while not progress_bar.finished:
            ...
            # This part seems unused in the original logic, keeping it as is.
            if False:
                points_3d_only_semantic_colormap = points_3d[mask_only_sem.sum(dim=1).to(bool)]
                if rgb_flag:
                    sem_color_only = rgb[mask_only_sem.sum(dim=1).to(bool)]
    ...
    # Define the transformation logic once to be reused
    ...
    pcd = transform_pcd(pcd, transform_json)
